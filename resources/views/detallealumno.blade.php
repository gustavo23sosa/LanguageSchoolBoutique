...
<div class="wrapper wrapper-full-page " style="background-image: url({{ asset('img/jan.jpg')}}); background-repeat: no-repeat; background-attachment: fixed; background-size: cover; color:#FFFFFF;">
